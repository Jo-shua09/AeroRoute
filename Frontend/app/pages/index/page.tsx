...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered predictive crowd intelligence and logistics routing for mega-gatherings and dense urban hubs." },
      { property: "og:title", content: "AeroRoute — Real-Time Human Flow Orchestration" },
      { property: "og:description", content: "Predictive crowd intelligence and logistics routing for mega-events." },
    ],
  }),
  component: Landing,
});
